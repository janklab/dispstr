function dispstrlib_make_release(newVersion)
% Cut a release of dispstr
%
% dispstrlib_make_release newVersion
%
...
echo("   https://github.com/janklab/dispstr/releases")
if ismac
  % TODO: Figure out how to do this on Windows and Linux
  system('open "https://github.com/janklab/dispstr/releases"')
end
